...
#pragma region Šî’êƒNƒ‰ƒX‚É‚ ‚é‹@”\‚Ì‹““®Ý’è
	...
	// “®“IƒIƒuƒWƒFƒNƒg‚Æ‚µ‚Ä‚Ì‹““®‚ð—LŒø‚É‚·‚é
	SetDynamicFlg(true);

	// d—Í‚ð—LŒø‚É‚·‚é
	SetGravityFlg(true);

	// Õ“ËŽž‚Ì‰Ÿ‚µo‚µ‚ð—LŒø‚É‚·‚é
	SetPushFlg(true);
...
#pragma region ƒvƒŒƒCƒ„[‚ª•ø‚¦‚é‰ºˆÊƒNƒ‰ƒX‚ð¶¬‚·‚é
...
void TomatoBoss::UiDraw(void)
{
	if (App::GetIns().IsDrawDebug()) {
		...
		// 1s‚¸‚Â•`‰æ‚·‚é‚½‚ß‚Ìƒ‰ƒ€ƒ_Ž®iƒfƒoƒbƒO—pj
